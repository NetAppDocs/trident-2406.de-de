...
Astra Trident verwendet den  `azure-netapp-files` Treiber zur Verwaltung des link:https://azure.microsoft.com/en-us/products/netapp/["Azure NetApp Dateien"^] Service.
