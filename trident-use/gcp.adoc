...
Astra Trident kann Cloud Volumes Service Volumes in einer von zwei erstellenlink:https://cloud.google.com/architecture/partners/netapp-cloud-volumes/service-types["Servicetypen"^]:
