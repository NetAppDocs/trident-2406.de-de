...
.Bevor Sie beginnen
Überprüfen Sie link:upgrade-trident.html#step-3-select-an-upgrade-method["Wählen Sie eine Aktualisierungsmethode aus"] vor dem Upgrade mit  `tridentctl`.
...
----
. Astra Trident erneut installieren. Siehe link:../trident-install/kubernetes-deploy-tridentctl.html["Installieren Sie Astra Trident mit tridentctl"].
