...
Informationen zu FlexGroups und zu Arbeitslasten, die für FlexGroups geeignet sind, finden Sie im  https://www.netapp.com/pdf.html?item=/media/12385-tr4571.pdf["NetApp FlexGroup Volume Best Practices und Implementierungsleitfaden"^].
